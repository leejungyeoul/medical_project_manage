        ...
        return (
            <div>
                <div className="pop_layout">
                    ...
                    <div className="pop_cnt pop_sitemap" ref="temp_ref">
                        <div className="pop_top">
                            <a href="#n" className="btn_close" onClick={this.closeBtnClick}>닫기</a>
                            <h3 className="pop_title">SITE MAP</h3>
                        </div>
                        <div className="pop_cont">
                            <dl className="sitemap_0st sitemap_1st">
                            <dt><a href="">My Projects</a></dt>
                            <dd></dd>
                            </dl>
                            <dl className="sitemap_0st sitemap_2st">
                            <dt><a href="">Research Projects</a></dt>
                            <dd></dd>
                            </dl>
                            <dl className="sitemap_0st sitemap_3st">
                            <dt><a href="">Software Tools</a></dt>
                            <dd></dd>
                            </dl>
                            <dl className="sitemap_0st sitemap_4st">
                            <dt><a href="">Data Sources</a></dt>
                            <dd></dd>
                            </dl>
                            <dl className="sitemap_0st sitemap_5st">
                    ...
                    <div className="pop_cnt pop_pri">
                        <div className="pop_top">
                            <a href="#n" className="btn_close">닫기</a>
                            <h3 className="pop_title">개인정보처리방침</h3>
                        </div>
                        <div className="pop_cont">
                            <textarea name="notice" id="" rows="15" value={notice_txt} onChange={this.handleChange}></textarea>
                        </div>
                    </div>

                    <div className="pop_cnt pop_email">
                        <div className="pop_top">
                            <a href="#n" className="btn_close">닫기</a>
                            <h3 className="pop_title">이메일주소무단수집거부</h3>
                        </div>
                        <div className="pop_cont">
                            <div className="em_cnt">
                            <h3>이메일주소 무단수집을 거부합니다.</h3>
                            <p>본 웹사이트에 게시된 이메일 주소가 전자우편 수집 프로그램이나 그 밖의 기술적 장치를 이용하여
                            <br /><span>무단으로 수집되는 것을 거부</span>하며, 이를 <span>위반시 정보통신망법에 의해 형사 처벌</span>됨을 유념하시기 바랍니다.</p>
                            </div>
                        </div>
                    </div>
                </div>
